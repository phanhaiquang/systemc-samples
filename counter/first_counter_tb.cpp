// Downloaded from http://www.asic-world.com/systemc/first1.html#Hello_World_Program_Output
// Modification:
//   sc_start(1) is changed to sc_start(<num>, SC_NS);
//   Because sc_start(1) is old syntax.
